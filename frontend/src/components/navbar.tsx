...
import {Dashboard, BareMetalServer, AssemblyCluster, UserAdmin, User, UserMultiple, Notebook} from "@carbon/icons-react";
  ...
  render() {
    ...
    managerNavs =
      <div className="dropdown">
        <UserAdmin className="icon-spacing"/>
      ...
      <div data-test="nav-bar">
        <div className="navigation-bar">
          ...
          <div className="dropdown-container">
            ...
            <div className="dropdown">
              <AssemblyCluster className="icon-spacing"/>
            ...
            <div className="dropdown">
              <UserMultiple className="icon-spacing"/>
            ...
            <div className="dropdown">
              <Notebook className="icon-spacing"/>
